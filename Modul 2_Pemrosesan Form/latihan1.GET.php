...
<head>
	<title>Metode GET</title> 		<!--digunakan untuk menuliskan judul -->
</head>
...
<?php   //awal php
if (isset($_GET['nama'])){  //menggunakan pernyataan if


echo 'Hallo, '. $_GET['nama']; //perintah untuk mencetak tulisan Hallo
}
